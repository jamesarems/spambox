...
BEGIN {
    my $error;
    $error = "ASSP file commander version $VERSION requires at least ASSP V2 build $requ_build\n" if $requ_build > $main::build || $main::version !~ /^2\./o;
    my %files = (
         'images/fc.js' => 1.03,
         'images/fc.css' => 1.03
    );
...
sub getDriveInfo {
    ...
    if ($^O eq 'MSWin32') {
        eval('use Win32::DriveInfo();1;') or do {
            mlog(0,"warning: ASSP_FC is missing module 'Win32::DriveInfo' - $@");
            return;
        };
        ...
        eval('use Filesys::Df();1;') or do {
            mlog(0,"warning: ASSP_FC is missing module 'Filesys::Df' - $@");
            return;
        };
...
my $title="ASSP file Commander $VERSION at $main::localhostname - ASSP $main::MAINVERSION - User: ".$main::WebIP{$ActWebSess}->{user};
my $Jscript  = "var mailext = '$main::maillogExt';\n";
   $Jscript .= "var sessionid = '$ActWebSess';\n";
   $Jscript .= "var asspbase = '$base/';\n";
...
<div id="frame">
  ...
  <div id="list-menu">
   <p>
    ...
    <a href="JavaScript:openConfig();" title="open the ASSP configuration page">Configuration</a>
    <a href="JavaScript:void();" title="not available in this version">Start</a>
    <span class="right"><a href="http://assp.cvs.sourceforge.net/viewvc/assp/assp2/filecommander/readme.html" target="_blank">help</a></span>
   </p>
  </div>
  <div id="panel">
...
sub file_zip {
    ...
    if ($ext eq 'zip') {
        ...
        mlog(0,"ASSP_FC: no possible compression methode found for $newzip");
    }
}
...
<html>
  ...
  <body>
    ...
    <br />
    <h1>ASSP File upload to $targetDir</h1>
